...
export const ActionCard = ({ title, buttonIcon, buttonContent, onClick }: ActionCardProps) => (
    <Col className={styles.col} span={8}>
        <Card className={styles.card} title={title} bordered={false}>
            <Button className={styles.btn} block type='link' icon={buttonIcon} onClick={onClick}>
                {buttonContent}
            </Button>
        </Card>
    </Col>
